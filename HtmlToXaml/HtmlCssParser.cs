...
{ // DependencyProperty
    ...
    internal static class HtmlCssParser
    {
        ...
        internal static void GetElementPropertiesFromCssAttributes(XmlElement htmlElement, string elementName, CssStylesheet stylesheet, IDictionary localProperties, List<XmlElement> sourceContext)
        {
        ...
        private static void ParseWordEnumeration(string[] words, string styleValue, ref int nextIndex, IDictionary localProperties, string attributeName)
        {
        ...
        private static void ParseCssColor(string styleValue, ref int nextIndex, IDictionary localValues, string propertyName)
        {
        ...
        private static void ParseCssFont(string styleValue, IDictionary localProperties)
        {
            int nextIndex = 0;
        ...
        private static void ParseCssListStyle(string styleValue, IDictionary localProperties)
        {
            int nextIndex = 0;
        ...
        private static void ParseCssTextTransform(string styleValue, ref int nextIndex, IDictionary localProperties)
        {
        ...
        private static void ParseCssTextAlign(string styleValue, ref int nextIndex, IDictionary localProperties)
        {
        ...
        private static void ParseCssVerticalAlign(string styleValue, ref int nextIndex, IDictionary localProperties)
        {
        ...
        private static void ParseCssFloat(string styleValue, ref int nextIndex, IDictionary localProperties)
        {
        ...
        private static void ParseCssBackground(string styleValue, ref int nextIndex, IDictionary localValues)
        {
    ...
    internal class CssStylesheet
    {
        ...
        public void DiscoverStyleDefinitions(XmlElement htmlElement)
        {
            ...
            for (IXmlNode htmlChildNode = htmlElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode.NextSibling)
            {
                ...
                {
                    stylesheetBuffer.Append(RemoveComments(htmlChildNode.NodeValue.ToString()));
                }
            }
        ...
        private bool MatchSelectorLevel(string selectorLevel, XmlElement xmlElement)
        {
            ...
            if (selectorTag != null && selectorTag != xmlElement.LocalName.ToString())
            {
                return false;
            }
