...
namespace HtmlToXaml
{
    ...
    internal class HtmlSchema
    {
        ...
        {
            _htmlElementsClosingColgroup = new List<string> {"colgroup", "tr", "thead", "tfoot", "tbody"};

            _htmlElementsClosingDD = new List<string> {"dd", "dt"};
            ...
            _htmlElementsClosingLI = new List<string> {"li"};
            // TODO: more complex recovery

            _htmlElementsClosingTbody = new List<string> {"tbody", "thead", "tfoot"};
            // TODO: more complex recovery

            _htmlElementsClosingTR = new List<string> {"thead", "tfoot", "tbody", "tr"};
            ...
            _htmlElementsClosingTD = new List<string> {"td", "th", "tr", "tbody", "tfoot", "thead"};
            // TODO: more complex recovery

            _htmlElementsClosingTH = new List<string> {"td", "th", "tr", "tbody", "tfoot", "thead"};
            // TODO: more complex recovery

            _htmlElementsClosingThead = new List<string> {"tbody", "tfoot"};
            // TODO: more complex recovery

            _htmlElementsClosingTfoot = new List<string> {"tbody", "thead"};
        ...
        private static List<string> _htmlInlineElements;

        private static List<string> _htmlBlockElements;

        private static List<string> _htmlOtherOpenableElements;

        // list of html empty element names
        private static List<string> _htmlEmptyElements;

        // names of html elements for which closing tags are optional, and close when the outer nested element closes
        private static List<string> _htmlElementsClosingOnParentElementEnd;
        ...
        private static List<string> _htmlElementsClosingColgroup;

        // names of elements closing the dd element
        private static List<string> _htmlElementsClosingDD;

        // names of elements closing the dt element
        private static List<string> _htmlElementsClosingDT;

        // names of elements closing the li element
        private static List<string> _htmlElementsClosingLI;

        // names of elements closing the tbody element
        private static List<string> _htmlElementsClosingTbody;

        // names of elements closing the td element
        private static List<string> _htmlElementsClosingTD;

        // names of elements closing the tfoot element
        private static List<string> _htmlElementsClosingTfoot;

        // names of elements closing the thead element
        private static List<string> _htmlElementsClosingThead;

        // names of elements closing the th element
        private static List<string> _htmlElementsClosingTH;

        // names of elements closing the tr element
        private static List<string> _htmlElementsClosingTR;
