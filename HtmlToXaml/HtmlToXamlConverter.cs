    ...
    public static class HtmlToXamlConverter
    {
        ...
        public static string GetAttribute(XmlElement element, string attributeName)
        {
            ...
            for (int i = 0; i < element.Attributes.Count; i++)
            {
                ...
                {
                    return element.Attributes[i].NodeValue.ToString();
                }
            }
        ...
        /// </returns>
        private static IXmlNode AddBlock(XmlElement xamlParentElement, IXmlNode htmlNode, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else if (htmlNode is XmlElement)
            {
                ...
                string htmlElementName = htmlElement.LocalName.ToString(); // Keep the name case-sensitive to check xml names
                string htmlElementNamespace = htmlElement.NamespaceUri.ToString();
        ...
        private static void AddSection(XmlElement xamlParentElement, XmlElement htmlElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            for (IXmlNode htmlChildNode = htmlElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode.NextSibling)
            {
            ...
            else
            {
                ...
                if (xamlElement.Attributes==null)
                {
                ...
                for (IXmlNode htmlChildNode = htmlElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
                {
        ...
        /// true indicates that a content added by this call contains at least one block element
        /// </param>
        private static void AddParagraph(XmlElement xamlParentElement, XmlElement htmlElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Create currentProperties as a compilation of local and inheritedProperties, set localProperties
            IDictionary localProperties;
            IDictionary currentProperties = GetElementProperties(htmlElement, inheritedProperties, out localProperties, stylesheet, sourceContext);
        ...
        /// </returns>
        private static IXmlNode AddImplicitParagraph(XmlElement xamlParentElement, IXmlNode htmlNode, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Collect all non-block elements and wrap them into implicit Paragraph
            XmlElement xamlParagraph = xamlParentElement.OwnerDocument.CreateElementNS(_xamlNamespace,HtmlToXamlConverter.Xaml_Paragraph);
            ...
            while (htmlNode != null)
            {
                ...
                else if (htmlNode is XmlText)
                {
                    ...
                    if (htmlNode.NodeValue.ToString().Trim().Length > 0)
                    {
                        AddTextRun(xamlParagraph, htmlNode.NodeValue.ToString());
                    }
                }
                else if (htmlNode is XmlElement)
                {
        ...
        private static void AddInline(XmlElement xamlParentElement, IXmlNode htmlNode, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            if (htmlNode is XmlComment)
            {
            ...
            {
                AddTextRun(xamlParentElement, htmlNode.NodeValue.ToString());
            }
            else if (htmlNode is XmlElement)
            {
                XmlElement htmlElement = (XmlElement)htmlNode;
                ...
                if (htmlElement.NamespaceUri.ToString() != HtmlParser.XhtmlNamespace)
                {
        ...
        private static void AddSpanOrRun(XmlElement xamlParentElement, XmlElement htmlElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            for (IXmlNode htmlNode = htmlElement.FirstChild; htmlNode != null; htmlNode = htmlNode.NextSibling)
            {
        ...
        private static void AddHyperlink(XmlElement xamlParentElement, XmlElement htmlElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
        ...
        {
            if (htmlComment.NodeValue.ToString() == "StartFragment")
            {
                InlineFragmentParentElement = xamlParentElement;
            }
            else if (htmlComment.NodeValue.ToString() == "EndFragment")
            {
        ...
        private static XmlElement ExtractInlineFragment(XmlElement xamlFlowDocumentElement)
        {
            ...
            {
                if (InlineFragmentParentElement.LocalName.ToString() == HtmlToXamlConverter.Xaml_Span)
                {
                ...
                else
                {
                    ...
                    {
                        IXmlNode copyNode = InlineFragmentParentElement.FirstChild;
        ...
        /// <param name="stylesheet"></param>
        /// <param name="sourceContext"></param>
        private static void AddList(XmlElement xamlParentElement, XmlElement htmlListElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            string htmlListElementName = htmlListElement.LocalName.ToLower();

            IDictionary localProperties;
            IDictionary currentProperties = GetElementProperties(htmlListElement, inheritedProperties, out localProperties, stylesheet, sourceContext);
            ...
            for (IXmlNode htmlChildNode = htmlListElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode.NextSibling)
            {
        ...
        /// </returns>
        private static XmlElement AddOrphanListItems(XmlElement xamlParentElement, XmlElement htmlLIElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            IXmlNode xamlListItemElementPreviousSibling = xamlParentElement.LastChild;
            XmlElement xamlListElement;
            if (xamlListItemElementPreviousSibling != null && xamlListItemElementPreviousSibling.LocalName.ToString() == Xaml_List)
            {
            ...
            IXmlNode htmlChildNode = htmlLIElement;
        ...
        /// Properties inherited from parent context
        /// </param>
        private static void AddListItem(XmlElement xamlListElement, XmlElement htmlLIElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Debug.Assert(xamlListElement != null);
            Debug.Assert(xamlListElement.LocalName.ToString() == Xaml_List);
            Debug.Assert(htmlLIElement != null);
            Debug.Assert(htmlLIElement.LocalName.ToLower() == "li");
            Debug.Assert(inheritedProperties != null);

            IDictionary localProperties;
            IDictionary currentProperties = GetElementProperties(htmlLIElement, inheritedProperties, out localProperties, stylesheet, sourceContext);
            ...
            for (IXmlNode htmlChildNode = htmlLIElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
            {
        ...
        private static XmlElement GetCellFromSingleCellTable(XmlElement htmlTableElement)
        {
            ...
            for (IXmlNode tableChild = htmlTableElement.FirstChild; tableChild != null; tableChild = tableChild.NextSibling)
            {
                ...
                if (elementName == "tbody" || elementName == "thead" || elementName == "tfoot")
                {
                    ...
                    for (IXmlNode tbodyChild = tableChild.FirstChild; tbodyChild != null; tbodyChild = tbodyChild.NextSibling)
                    {
                        if (tbodyChild.LocalName.ToLower() == "tr")
                        {
                            ...
                            for (IXmlNode trChild = tbodyChild.FirstChild; trChild != null; trChild = trChild.NextSibling)
                            {
                ...
                else if (tableChild.LocalName.ToLower() == "tr")
                {
                    ...
                    for (IXmlNode trChild = tableChild.FirstChild; trChild != null; trChild = trChild.NextSibling)
                    {
                        string cellName = trChild.LocalName.ToLower();
                        if (cellName == "td" || cellName == "th")
                        {
        ...
        /// <param name="stylesheet"></param>
        /// <param name="sourceContext"></param>
        private static void AddColumnInformation(XmlElement htmlTableElement, XmlElement xamlTableElement, IList columnStartsAllRows, IDictionary currentProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                for (IXmlNode htmlChildNode = htmlTableElement.FirstChild; htmlChildNode != null; htmlChildNode = htmlChildNode.NextSibling)
                {
        ...
        /// Properties inherited from parent context
        /// </param>
        private static void AddTableColumnGroup(XmlElement xamlTableElement, XmlElement htmlColgroupElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            IDictionary localProperties;
            IDictionary currentProperties = GetElementProperties(htmlColgroupElement, inheritedProperties, out localProperties, stylesheet, sourceContext);

            // TODO: process local properties for colgroup

            // Process children of colgroup. Colgroup may contain only col elements.
            for (IXmlNode htmlNode = htmlColgroupElement.FirstChild; htmlNode != null; htmlNode = htmlNode.NextSibling)
            {
        ...
        /// <param name="stylesheet"></param>
        /// <param name="sourceContext"></param>
        private static void AddTableColumn(XmlElement xamlTableElement, XmlElement htmlColElement, IDictionary inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            IDictionary localProperties;
            IDictionary currentProperties = GetElementProperties(htmlColElement, inheritedProperties, out localProperties, stylesheet, sourceContext);
        ...
        /// </returns>
        private static IXmlNode AddTableRowsToTableBody(XmlElement xamlTableBodyElement, IXmlNode htmlTRStartNode, IDictionary currentProperties, IList columnStarts, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Debug.Assert(xamlTableBodyElement.LocalName.ToString() == Xaml_TableRowGroup);
            Debug.Assert(currentProperties != null);

            // Initialize child node for iteratimg through children to the first tr element
            IXmlNode htmlChildNode = htmlTRStartNode;
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLower() != "tbody")
            {
                if (htmlChildNode.LocalName.ToLower() == "tr")
                {
                    ...
                    IDictionary trElementLocalProperties;
                    IDictionary trElementCurrentProperties = GetElementProperties((XmlElement)htmlChildNode, currentProperties, out trElementLocalProperties, stylesheet, sourceContext);
        ...
        /// </returns>
        private static IXmlNode AddTableCellsToTableRow(XmlElement xamlTableRowElement, IXmlNode htmlTDStartNode, IDictionary currentProperties, IList columnStarts, IList activeRowSpans, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // parameter validation
            Debug.Assert(xamlTableRowElement.LocalName.ToString() == Xaml_TableRow);
            Debug.Assert(currentProperties != null);
            if (columnStarts != null)
            {
            ...
            IXmlNode htmlChildNode = htmlTDStartNode;
            ...
            while (htmlChildNode != null && htmlChildNode.LocalName.ToLower() != "tr" && htmlChildNode.LocalName.ToLower() != "tbody" && htmlChildNode.LocalName.ToLower() != "thead" && htmlChildNode.LocalName.ToLower() != "tfoot")
            {
                if (htmlChildNode.LocalName.ToLower() == "td" || htmlChildNode.LocalName.ToLower() == "th")
                {
                    ...
                    IDictionary tdElementLocalProperties;
                    IDictionary tdElementCurrentProperties = GetElementProperties((XmlElement)htmlChildNode, currentProperties, out tdElementLocalProperties, stylesheet, sourceContext);
        ...
        /// </param>
        private static void AddDataToTableCell(XmlElement xamlTableCellElement, IXmlNode htmlDataStartNode, IDictionary currentProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            // Parameter validation
            Debug.Assert(xamlTableCellElement.LocalName.ToString() == Xaml_TableCell);
            Debug.Assert(currentProperties != null);

            for (IXmlNode htmlChildNode = htmlDataStartNode; htmlChildNode != null; htmlChildNode = htmlChildNode != null ? htmlChildNode.NextSibling : null)
            {
        ...
        /// </returns>
        private static IList AnalyzeTableStructure(XmlElement htmlTableElement, CssStylesheet stylesheet)
        {
            // Parameter validation
            Debug.Assert(htmlTableElement.LocalName.ToLower() == "table");
        ...
        /// </param>
        private static double AnalyzeTRStructure(XmlElement htmlTRElement, IList columnStarts, IList activeRowSpans, double tableWidth, CssStylesheet stylesheet)
        {
            double columnWidth;
            ...
            IXmlNode htmlChildNode = htmlTRElement.FirstChild;
            int columnIndex = 0;
            double trWidth = 0;
        ...
        public const string Xaml_InlineUIContainer_Image = "Image";
